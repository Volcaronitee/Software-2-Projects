...
public abstract class ProgramTest {
     ...
     * The name of a file containing a BL program.
     */
    private static final String FILE_NAME_2 = "data/program-file-one.bl";

    /**
     * The name of a file containing a BL program.
     */
    private static final String FILE_NAME_3 = "data/empty-program.bl";
    ...
    /**
     * Test name two with created program program-file-one.bl.
     */
    @Test
    public final void testName2() {
        ...
        assertEquals(pRef, pTest);
        assertEquals("FileOne", result);
    }

    /**
     * Test setName two with created program program-file-one.bl.
     */
    @Test
    ...
    /**
     * Test newContext two with created program program-file-one.bl.
     */
    @Test
    ...
    /**
     * Test swapContext for instruction turnAround in created program
     * program-file-one.bl.
     */
    @Test
    public final void testSwapContext2forTurnAround() {

        Program pTest = this.createFromFileTest(FILE_NAME_2);
        Program pRef = this.createFromFileRef(FILE_NAME_2);
        Map<String, Statement> contextRef = pRef.newContext();
        Map<String, Statement> contextTest = pTest.newContext();
        String turnAroundName = "turnAround";
        pRef.swapContext(contextRef);
        Pair<String, Statement> oneRef = contextRef.remove(turnAroundName);
        pRef.swapContext(contextRef);
        contextRef.add(oneRef.key(), oneRef.value());
        ...
        pTest.swapContext(contextTest);
        Pair<String, Statement> oneTest = contextTest.remove(turnAroundName);
        pTest.swapContext(contextTest);
        contextTest.add(oneTest.key(), oneTest.value());
    ...
    /**
     * Test swapContext two for instruction spinAndInfect in created program
     * program-file-one.bl.
     */
    @Test
    public final void testSwapContext2forSpinAndInfect() {

        Program pTest = this.createFromFileTest(FILE_NAME_2);
        Program pRef = this.createFromFileRef(FILE_NAME_2);
        Map<String, Statement> contextRef = pRef.newContext();
        Map<String, Statement> contextTest = pTest.newContext();
        String turnAroundName = "spinAndInfect";
        pRef.swapContext(contextRef);
        Pair<String, Statement> oneRef = contextRef.remove(turnAroundName);
        pRef.swapContext(contextRef);
        contextRef.add(oneRef.key(), oneRef.value());
    ...
    /**
     * Test newBody two with created program program-file-one.bl.
     */
    @Test
    ...
    /**
     * Test swapBody two with created program program-file-one.bl.
     */
    @Test
    ...
    /**
     * Test name three with created program empty-program.bl.
     */
    @Test
    public final void testName3() {
        ...
        assertEquals(pRef, pTest);
        assertEquals("empty-program", result);
    }

    /**
     * Test setName three with created program empty-program.bl.
     */
    @Test
    ...
    /**
     * Test newContext three with created program empty-program.bl.
     */
    @Test
    ...
    /**
     * Test newBody three with created program empty-program.bl.
     */
    @Test
