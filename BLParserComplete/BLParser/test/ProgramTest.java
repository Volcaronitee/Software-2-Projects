...
public abstract class ProgramTest {
    ...
    private static final String FILE_NAME_1 = "test/program1.bl",
            ...
            FILE_NAME_3 = "test/programPrOglAm.bl",
            FILE_NAME_4 = "test/programMissingIs.bl",
            FILE_NAME_5 = "test/programEmptyValidInput.bl",
            FILE_NAME_6 = "test/programNoContextValid.bl",
            FILE_NAME_7 = "test/programNoBodyInvalid.bl",
            FILE_NAME_8 = "test/programImproperIdentifier.bl";
    ...
    /**
     * Test of a program with no context.
     */
    @Test
    public final void testParseValidNoContext() {
    ...
    /**
     * Test of parse on the first token, "PROGRAM" expected.
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorOnFirstToken() {
    ...
    /**
     * Test of parse on a file missing an "IS" token.
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorOnMissingIs() {
    ...
    /**
     * Test of parse on a file missing entire body.
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorOnMissingBody() {
    ...
    /**
     * Test of parse on a file with an improper identifier.
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorOnImproperIdentifier() {
